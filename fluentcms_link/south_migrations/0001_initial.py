...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contentitem_fluentcms_link_linkitem', (
        ...
        db.send_create_signal(u'fluentcms_link', ['LinkItem'])


    def backwards(self, orm):
        # Deleting model 'LinkItem'
        db.delete_table(u'contentitem_fluentcms_link_linkitem')
