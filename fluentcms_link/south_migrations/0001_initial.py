...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contentitem_fluentcms_link_linkitem', (
            ...
            ('url', self.gf('fluent_contents.extensions.PluginUrlField')(max_length=300, null=True, blank=True)),
        ...
        db.send_create_signal('fluentcms_link', ['LinkItem'])


    def backwards(self, orm):
        # Deleting model 'LinkItem'
        db.delete_table('contentitem_fluentcms_link_linkitem')
    ...
    models = {
        ...
        'fluentcms_link.linkitem': {
            'Meta': {'ordering': "('placeholder', 'sort_order')", 'object_name': 'LinkItem', 'db_table': "u'contentitem_fluentcms_link_linkitem'", '_ormbases': ['fluent_contents.ContentItem']},
